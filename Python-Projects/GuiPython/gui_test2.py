from guizero import App, Combo, Text, CheckBox, ButtonGroup, PushButton,
...
#Combo allows for drop down menu to be made 
...
seat_position = Text(app, text="Seat Type", grid=[0,2], align="left")
